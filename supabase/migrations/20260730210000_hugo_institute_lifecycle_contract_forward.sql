-- Forward-only lifecycle ownership repair after 20260730200000.
-- Keep 20260730200000 immutable; this later migration reinforces the fixed
-- wrapper and restores the Institute-owned role on terminal revocation.
...
begin
  ...
  if p_status = 'revoked' and v_lock_user_id is not null then
    ...
    -- the locked role and membership snapshot before returning its receipt.
    update public.profiles
    set system_role = v_current_role
