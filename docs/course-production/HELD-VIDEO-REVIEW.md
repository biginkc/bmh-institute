# Held corrected videos

Updated: 2026-07-16

## Review rule

These six corrected cuts are the only candidates for their slots. They passed
technical QC but do not have a later explicit Jarrad approval in the inspected
records. Do not substitute an older known-defective version. Do not change a
manifest asset from `hold` to `approved` until Jarrad has watched and approved
that exact file.

All six use H264 video at 1600 by 900 in yuv420p plus AAC 48 kHz stereo audio.
