...
One exact corrected cut, KPIs v12, passed technical QC but does not have a later
explicit Jarrad approval in the inspected records. It is the only approvable
candidate on this review surface. Seven other held source cuts require new
...
The review surface contains the pending KPIs v12 cut and the seven replacement-
required sources. All eight use H264 video at 1600 by 900 in yuv420p plus AAC
48 kHz stereo audio.
...
The pending cut does not have finalized learner captions while approval is
pending. Captions or transcripts attached to replacement-required sources are
checksum-locked review evidence and must not be treated as finalized learner
assets.
The machine-readable approval record is
`held-video-review/approvals.json`; one corrected candidate remains pending and
...
| KPIs and Sales Telemetry | `course-assets/review-lesson12A/LESSON-12A-v12-LOCAL-POLICY-CUT.mp4` | 400.994 seconds | 53,799,917 bytes | `3d50cc79cfe74277ac1311367d5b0bd6fd62d2d38c2c74fff8732ea62203d61a` | Pending exact-cut approval; removes the compensation-promise phrase |
...
The Terms Glossary v10 local-policy cut was approved by Jarrad on 2026-07-17
and is no longer in the held set. Its exact SHA-256 is
`6f57600d6ec3a596f96175052eda997503ab9b72aa5b7e9ec02239fe1a125769`.
The rejected v9 checksum remains in the append-only approval history.

For the one remaining corrected candidate, record the exact SHA-256, approval
...
contain older and rejected cuts with similar names. The seven replacement-
