...
AV_CAFE = "b2cd05454d284058ad8d7303545821e6"   # Cafe Andrea (bookends b01/b09)
...
CLIPS.append(("hero_b09_outro", "b09_outro", AV_CAFE, "seated at the cafe table, warm and upbeat, minimal natural gestures, friendly send-off"))
...
for _ in range(90):
    ...
    for name, vid in list(pending.items()):
        ...
        save()
print("6A CLIPS DONE:", sum(1 for c in C.values() if c.get("file")), "/", len(CLIPS), flush=True)
