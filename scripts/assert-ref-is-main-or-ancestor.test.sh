...
# project). Ported from Sandra's identical test (PR #345) alongside the
# script it exercises. Proves the four cases that matter:
...
WORKDIR="$(mktemp -d "${TMPDIR:-/tmp}/institute-ref-guard-test-XXXXXX")"
