...
- [x] **TEST-03**: Playwright write-path coverage exercises invite acceptance, quiz submission, assignment upload, admin approval and revision, and password reset against the prod-config harness. Closed by seeded non-production E2E in PR #39 and PR #40 plus production email-link readiness in PR #45.
